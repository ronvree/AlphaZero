...
from alphazero.self_play import policy_iter_self_play

if __name__ == '__main__':

    parser = argparse.ArgumentParser(description='AlphaZero on Connect 4')
    ...
    model = policy_iter_self_play(Connect4, model, args)
